                                    ...
                                    if ($ret["stat"]) {
                                        ...
                                        if ($res->num_rows != 0) {
                                            while ($row = $res->fetch_assoc()) {
                                                ...
                                                echo '<td><div class="btn-group" role="group"><a class="btn btn-outline-success" download="' . $row["Nombre"] . ' (Pedido).png" href="data:image/png;base64, ' . $image_data_base64 . '"><i class="bi bi-download"></i></a><a class="btn btn-outline-primary" href="presupuesto.php?ID=' . $row["ID"] . '"><i class="bi bi-clipboard-check"></i></a></div></td>';
                                                echo '</tr>';
                                            }
                                        } else {
                                            $ret["stat"] = false;
